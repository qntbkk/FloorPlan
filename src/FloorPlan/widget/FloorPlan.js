define([
    ...
    "FloorplanFilesystem",
    "FloorplannerWallBuildingTool",
    "FloorplannerWallReshapingTool",
    "FloorplanUI",
    "dojo/text!trainingWidget/widget/template/trainingWidget.html"
], function (declare, _WidgetBase, _TemplatedMixin, lang, FloorplanFilesystem, FloorplannerWallBuildingTool, FloorplannerWallReshapingTool, FloorplanUI, utils, /*_jQuery,*/ widgetTemplate) {
    "use strict";
